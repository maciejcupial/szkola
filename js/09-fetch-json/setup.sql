-- Database shop, the same as in PHP lessons 18-22 (4Ti 20-24). Import in phpMyAdmin (tab SQL).
-- Import again to reset the data; expected results in tasks/ assume a fresh import.
