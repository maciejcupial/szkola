...
echo "<h2>Lekcja 19, slajdy 5-6 i ćwiczenie ze slajdu 8: wszystkie produkty</h2>";
...
while ($row = mysqli_fetch_assoc($result)) {
    echo htmlspecialchars($row["name"]) . " - " . $row["price"] . " zł<br>";
}
// Kubek - 19.90 zł
// Długopis - 3.50 zł
// Zeszyt - 7.20 zł

echo "<h2>Lekcja 19, slajd 4: SELECT jako sito, WHERE price &lt; 10</h2>";
